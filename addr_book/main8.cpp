...
void modifyPerson(Addressbook &addr_book);                         // 修改指定联系人
void clearAddrBook(Addressbook &addr_book);                        // 清空通讯录
...
{ // 选择界面
    ...
    while (true)
    {
        ...
        case 4: // 查找联系人
            ...
            break;
        case 5: // 修改联系人
            modifyPerson(addr_book);
            break;
        case 6: // 清空联系人
            clearAddrBook(addr_book);
            break;
        case 0: // 退出通讯录
...
void modifyPerson(Addressbook &addr_book)
{ // 修改指定联系人 可以更改修改逻辑 当前是覆写逻辑
    cout << "请输入您要修改的联系人:";
    string name;
    cin >> name;

    int person_index = isExist(addr_book, name);
    if (person_index == -1)
    {
        cout << "查无此人" << endl;
    }
...
void clearAddrBook(Addressbook &addr_book)
{ // 清空通讯录
    addr_book.m_Size = 0;
    cout << "通讯录已清空" << endl;
}